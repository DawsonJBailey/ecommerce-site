...
export function* getSnapshotFromUserAuth(userAuth, additionalDetails) {
    try {
        ...
        // ZTM messed up this part trying to use userSnapshot.data() so my fix is to get the info from userAuth
        yield put(signInSuccess({id: userSnapshot.id, displayName: additionalDetails?.displayName, email: userAuth.email, createdAt: userAuth.metadata.createdAt}))
    } catch(error) {
